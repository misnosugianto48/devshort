        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}" class="bg-indigo-600 text-white px-6 py-2.5 rounded-full font-bold hover:bg-indigo-700 shadow-md transition transform hover:scale-105">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="font-medium text-slate-600 hover:text-indigo-600 transition">Masuk</a>
                        <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-6 py-2.5 rounded-full font-bold hover:bg-indigo-700 shadow-md transition transform hover:scale-105">Daftar Gratis</a>
                    @endauth
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
                        ...
                        @auth
                            <a href="{{ route('dashboard') }}" class="w-full py-3 text-center rounded-xl border-2 border-indigo-600 text-indigo-600 font-bold hover:bg-indigo-50 transition block">Buka Dashboard</a>
                        @else
                            <a href="{{ route('register') }}" class="w-full py-3 text-center rounded-xl border-2 border-indigo-600 text-indigo-600 font-bold hover:bg-indigo-50 transition block">Mulai Sekarang</a>
                        @endauth
                    </div>
                    <!-- Pro Plan -->
                    <div class="bg-white p-10 rounded-3xl border-4 border-indigo-500 shadow-xl flex flex-col relative scale-105 z-10">
                        ...
                        @auth
                            <a href="{{ route('dashboard') }}" class="w-full py-3 text-center rounded-xl gradient-bg text-white font-bold hover:opacity-90 shadow-lg transition block">Mulai Pro</a>
                        @else
                            <a href="{{ route('register') }}" class="w-full py-3 text-center rounded-xl gradient-bg text-white font-bold hover:opacity-90 shadow-lg transition block">Upgrade ke Pro</a>
                        @endauth
                    </div>
                    <!-- Enterprise Plan -->
                    <div class="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
                        ...
                        <a href="mailto:support@devshort.id" class="w-full py-3 text-center rounded-xl border-2 border-slate-800 text-slate-800 font-bold hover:bg-slate-50 transition block">Hubungi Sales</a>
                    </div>
                </div>
            </div>
        </section>
